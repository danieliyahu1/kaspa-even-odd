...
// script, so persisting it would write the commit-reveal secret to the PVC
// before broadcast. Reveal preparations therefore live only in process memory
// with a short TTL; losing them on restart only costs the client a re-prepare.
